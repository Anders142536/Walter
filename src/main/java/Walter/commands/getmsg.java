...
public class getmsg extends Command {
    ...
    public getmsg() {
        keywords = new String[][]{new String[]{"getmsg"}};
    }
    @Override
    public String getDescription() {
        return "Ich werfe die Nachricht mit der ID **ID** in den Chat und die Konsole aus. Um die ID von Nachrichten " +
    ...
    public String getDescriptionEnglish() {
        return "I print the message with the ID **ID** both into the chat and the console. To access the IDs of " +
